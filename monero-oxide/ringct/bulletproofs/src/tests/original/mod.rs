...
fn bulletproofs_vector() {
  ...
  assert!(Bulletproof::Original(OriginalProof {
    A: CompressedPoint::from(hex!(
      "ef32c0b9551b804decdcb107eb22aa715b7ce259bf3c5cac20e24dfa6b28ac71"
    )),
    S: CompressedPoint::from(hex!(
      "e1285960861783574ee2b689ae53622834eb0b035d6943103f960cd23e063fa0"
    )),
    T1: CompressedPoint::from(hex!(
      "4ea07735f184ba159d0e0eb662bac8cde3eb7d39f31e567b0fbda3aa23fe5620"
    )),
    T2: CompressedPoint::from(hex!(
      "b8390aa4b60b255630d40e592f55ec6b7ab5e3a96bfcdcd6f1cd1d2fc95f441e"
    )),
